...
import { BarChart3, ChevronDown, ChevronRight, Crown, Users } from 'lucide-react';
                  ...
                  <tr key={m.user_id} className="border-b border-slate-50">
                    <td className="px-6 py-3">
                      <div className="flex items-center gap-2">
                        {m.role.toLowerCase().endsWith('admin') && (
                    ...
                    <td className="px-6 py-3">
                      <Badge variant={m.role.toLowerCase().endsWith('admin') ? 'info' : 'default'} size="sm">
                        {m.role}
                      </Badge>
                    </td>
